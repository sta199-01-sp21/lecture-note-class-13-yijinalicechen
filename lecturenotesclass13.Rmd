...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-yijinalicechen/manhattan.csv")
```
...
What does this mean?
We are 95% confident that the proportion of mice that died while not on treatment is between 69% and 79.7%.
...
visualise(boot_prop_90) +
  shade_ci(ci_mice_died)
```


Give an interpretation of your result.
We are 90% confident that the proportion of mice that died while not on treatment is between 69.7% and 78.9%.
